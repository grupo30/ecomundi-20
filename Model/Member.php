...
class Member
{
     ...
     * entrar / registrar
     *
     * @return string[] registrar status msg
     */
    public function registerMember()
    {
        ...
        if ($isUsernameExists) {
            ...
            if (! empty($_POST["signup-password"])) {
                ...
                $hashedPassword = password_hash($_POST["signup-password"], PASSWORD_DEFAULT); //funcao de cryptografia 
            }
            ...
            if (! empty($memberId)) {
                $response = array(
                    "status" => "Sucesso!",
                    "message" => "Voce se registrou com sucesso!"
                );
            }
        }
        return $response;
    ...
    public function loginMember()
    {
        ...
        if ($loginPassword == 1) {
            ...
            $loginStatus = "Loguin ou senha inválidos.";
            return $loginStatus;
        }
    }
}
