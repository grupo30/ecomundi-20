...
body{
        ...
        background-position: center; /* Imagen no centro. */
  		background-repeat: no-repeat; /* Para nao repetir a imagem. */
  		background-size: cover; /* Redimensionar para cobrir o fundo todo. */
}
.sign-up-container{
  		background-image: linear-gradient(to right, #30763A , #71BA66);
}
.form-label{
		...
		<div class="sign-up-container">
			...
			<div class="signup-align">
				<form name="login" action="" method="post"
					...
					<div class="signup-heading"  style="color:white;">Ecomundi</div>
					<div class="logo-picture"><img src="./assets/profile-1.png" alt="Ecomundi"></div>
